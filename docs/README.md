...
```mermaid
graph TD
    PKM[🧠 PKM FRENTE URUPÊ] --> D1[01-manifesto: Teoria & Princípios]
    PKM --> D2[02-arquitetura: Engenharia & Protocolos]
    PKM --> D3[03-produtos: Especificação dos 3 Pilares]
    PKM --> D4[04-discord: Matriz de Canais & Automação]
```
